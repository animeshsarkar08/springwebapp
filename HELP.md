...
* The original package name 'com.sarkaranimesh.gadgetgalaxy ' is invalid and this project uses 'com.sarkaranimesh.gadgetgalaxy' instead.
...
```
$ docker run --rm -p 8080:8080 gadgetgalaxy :0.0.1-SNAPSHOT
```
